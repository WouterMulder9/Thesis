...
test = identity_match(project_log, name_column = c('author_name_email','reply_from'),
...
start_date <- project_reply["8737","reply_datetimetz"]
end_date <- project_reply["66494","reply_datetimetz"]
...
oslom_dir_path = '~/Downloads/OSLOM2/OSLOM2/olsom_dir'
oslom_undir_path = '~/Downloads/OSLOM2/OSLOM2/olsom_undir'
...
for(j in 2:size_time_window){
  ...
  project_reply_slice <- project_reply[(project_reply$reply_datetimetz >= start_day) & 
                                         (project_reply$reply_datetimetz < end_day)]
